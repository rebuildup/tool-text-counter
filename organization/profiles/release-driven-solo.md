...
tool-text-counter の current release-driven development で使用する Operating Model を定義します。
...
- Token-count behavior using js-tiktoken is a version-sensitive product fact; validate representative inputs when dependency behavior changes.
